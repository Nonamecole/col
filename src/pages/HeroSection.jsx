    ...
    <div className="hero-section">
      <Container>
        <Row className="align-items-center">
          <Col md={6}>
            <div className="hero-content text-center">
              <h1 className="hero-title">
                <span className="hero-highlight-red">e</span>Poultry
              </h1>
          ...
          <Col md={6}>
            <div className="carousel slide" data-bs-ride="carousel" data-aos="fade-left" ref={slideshowRef}>
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src={poultry1} className="d-block w-100 img-fluid" alt="Slide 1" />
                </div>
                <div className="carousel-item">
                  <img src={poultry2} className="d-block w-100 img-fluid" alt="Slide 2" />
                </div>
                <div className="carousel-item">
                  <img src={poultry3} className="d-block w-100 img-fluid" alt="Slide 3" />
                </div>
              </div>
            </div>
          </Col>
